  ...
  return (
    <div className="w-full h-full">
      ...
      <section className="pl-20 pr-96 mb-24 flex flex-col gap-8">
        <div>
          <h2 className="text-lg font-medium mb-2">1. Acceptarea termenilor</h2>
        ...
        <div>
          <h2 className="text-lg font-medium mb-2">5. Livrare și returnări</h2>
          <div className="flex gap-2">
        ...
        <div>
          <h2 className="text-lg font-medium mb-2">6. Contul utilizatorului</h2>
          <div className="flex gap-2">
            <span className="w-6">2.1.</span>
            <p>
