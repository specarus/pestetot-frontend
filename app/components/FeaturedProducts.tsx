...
const FeaturedProducts = () => {
  return (
    <div className="w-full grid grid-cols-5 desktop:gap-8 laptop:gap-4">
      <Link
        href="/catalog/mulinete"
        className="group relative col-span-1 desktop:h-80 laptop:h-64 bg-white rounded-md shadow-lg hover:shadow-xl overflow-hidden border border-gray-100 hover:-translate-y-1 transition-all duration-300"
      >
        <div className="w-full h-full grid place-content-center p-10">
          ...
          <span className="absolute w-full left-0 bottom-16 bg-white h-10 flex items-center justify-center group-hover:h-14 transition-all border-t border-b border-black duration-300">
            <h2 className="relative group uppercase desktop:text-xl laptop:text-lg italic">
              Mulinete
      ...
      <Link
        ...
        className="group relative col-span-1 desktop:h-80 laptop:h-64 bg-white shadow-lg hover:shadow-xl rounded-md overflow-hidden border border-gray-100 hover:-translate-y-1 transition-all duration-300"
      >
